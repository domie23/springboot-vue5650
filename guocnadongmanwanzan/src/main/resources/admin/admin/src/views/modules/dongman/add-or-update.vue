    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="作者名称" prop="dongmanName">
                       <el-input v-model="ruleForm.dongmanName"
                                 placeholder="作者名称" clearable  :readonly="ro.dongmanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="作者名称" prop="dongmanName">
                           <el-input v-model="ruleForm.dongmanName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="作者详情" prop="dongmanContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.dongmanContent" label="作者详情" prop="dongmanContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zhuangtaiTypes: [
                              { required: true, message: '作者状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   dongmanContent: [
                              { required: true, message: '作者详情不能为空', trigger: 'blur' },
                          ],
                   dongmanDelete: [
